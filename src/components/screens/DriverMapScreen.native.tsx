...
// Fallback route used when there's nothing to pop back to (e.g. this screen
// was opened directly via a push notification deep link) — adjust to match
// the driver app's actual home/dashboard route.
